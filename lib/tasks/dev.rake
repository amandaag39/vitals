...
#   if user.persisted?
#     vital_name = "Blood Oxygen"
#     vital = user.vitals.create!(name: vital_name, category: :numerical)
...
#   puts "Added #{User.count} User, #{Vital.count} Vital, and #{Reading.count} Reading."
# end
